        ...
        <div>
            <Box boxShadow={"rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;"}>
                ...
                <Box height={"90px"} display={"flex"} justifyContent={"space-between"} alignItems={"center"}>
                    ...
                    <Box  onClick={() =>  setIsTrue(false)} onMouseLeave={() =>  setIsTrue(true)}  w={{ sm: '30em', md: '48em', lg: '20em' }} h={{ lg: "45px" }} ml={"200px"} bg={"#eaeaea"} borderRadius={"2em"} display={"flex"} alignItems={"center"} paddingLeft={"20px"}>
                        {
                            isTrue ? < Box display={"flex"} alignItems={"center"} justifyContent={"space-evenly"}> 
                              <AiOutlineSearch size={30} /><Text fontSize={"18px"}>Search</Text><TypewriterInput /></Box>
                                : < Box display={"flex"} alignItems={"center"} justifyContent={"space-evenly"}> 
                                <AiOutlineSearch size={30} /><Search /></Box> 
